...
mkdir cache/aladin
mkdir cache/java
java -Xmx6G -Djava.io.tmpdir=./cache/java -jar aladin.jar in="./danielkurtin" out="./public/danielkurtin" maxThread=20 cache="./cache/aladin" cacheRemoveOnExit=false order=8 id=HERE/p/danielkurtin color=png mode=overlayFading
